<section id="home" class="relative flex min-h-screen items-center overflow-hidden bg-slate-950">

    <!-- Background Glow -->
    <div class="nebula w-[500px] h-[500px] bg-violet-600 top-20 left-20">
    </div>

    <div class="nebula w-[400px] h-[400px] bg-sky-500 bottom-20 right-10">
    </div>
    <div class="absolute -left-40 -top-40 h-[500px] w-[500px] rounded-full bg-violet-600/20 blur-[180px]">
    </div>

    <div class="absolute bottom-0 right-0 h-[450px] w-[450px] rounded-full bg-sky-500/10 blur-[180px]">
    </div>
    ...
    <div
        class="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-6 pt-28 lg:grid-cols-2 lg:px-10">
...
bg-sky-500/10 px-4 py-2 text-sm text-sky-300">
        ...
        <div class="relative flex items-center justify-center">
            ...
            <!-- Outer Glow -->
            <div class="absolute h-[520px] w-[520px] rounded-full bg-violet-500/10 blur-[160px]">
            </div>

            <!-- Circle Border -->
            <div class="absolute h-[380px] w-[380px] rounded-full border border-violet-400/20">
            </div>

            <!-- Moon -->
            <div
                class="absolute h-[320px] w-[320px] rounded-full bg-gradient-to-br from-white via-slate-200 to-slate-400 shadow-[0_0_100px_rgba(255,255,255,.35)]">
            </div>
    ...
    <div class="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center">
        ...
        <span class="text-sm tracking-[4px] text-slate-400 mb-3">
            SCROLL
        </span>

        <div class="w-7 h-12 rounded-full border border-slate-500 flex justify-center">
